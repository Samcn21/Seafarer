...
public class EventManager : MonoBehaviour
{
	...
	public delegate void OnEvent(GameData.InternalEventType Event_Type, Component Sender, object Param = null);

	//Array of listener objects (all objects registered to listen for events)
    private Dictionary<GameData.InternalEventType, List<OnEvent>> Listeners = new Dictionary<GameData.InternalEventType, List<OnEvent>>();
	#endregion
    ...
    public void AddListener(GameData.InternalEventType Event_Type, OnEvent Listener)
	{
    ...
    public void PostNotification(GameData.InternalEventType Event_Type, Component Sender, object Param = null)
	{
    ...
    public void RemoveEvent(GameData.InternalEventType Event_Type)
	{
	...
	public void RemoveRedundancies()
	{
        ...
        Dictionary<GameData.InternalEventType, List<OnEvent>> TmpListeners = new Dictionary<GameData.InternalEventType, List<OnEvent>>();
		
		//Cycle through all dictionary entries
        foreach (KeyValuePair<GameData.InternalEventType, List<OnEvent>> Item in Listeners)
		{
