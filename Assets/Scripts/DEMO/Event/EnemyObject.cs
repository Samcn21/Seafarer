...
public class EnemyObject : MonoBehaviour
{
	...
	public int Health
	{
		...
		set
		{
            ...
            EventManager.Instance.PostNotification(GameData.InternalEventType.HEALTH_CHANGE, this, _health);
		}
	}
	//-------------------------------------------------------
	public int Ammo
	{
		...
		set
		{
            ...
            EventManager.Instance.PostNotification(GameData.InternalEventType.AMMO_CHANGE, this, _health);
		}
	}
	//-------------------------------------------------------
	...
	void Start()
	{
        ...
        EventManager.Instance.AddListener(GameData.InternalEventType.HEALTH_CHANGE, OnEvent);
	}
	//-------------------------------------------------------
    ...
    public void OnEvent(GameData.InternalEventType Event_Type, Component Sender, object Param = null)
	{
		//Detect event type
		switch(Event_Type)
		{
            case GameData.InternalEventType.HEALTH_CHANGE:
